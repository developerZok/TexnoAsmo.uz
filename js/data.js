...
let kolonka = [
    {
        ...
        description: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem quisquam ducimus neque sit animi numquam?'
    },
    {
        id: 2,
        title: "kolonka 2",
...
dazmol2 && dazmol.slice(0, 4).map(elem => {
    dazmol2.push(elem)
})
lazer && lazer.slice(0, 4).map(elem => {
    lazer2.push(elem)
})
stanog && stanog.slice(0, 4).map(elem => {
    stanog2.push(elem)
})
    kolonka2.map(elem => {
        dates.push(elem)
    ...
    dazmol2.map(elem => {
        dazmoldates.push(elem)
    })
    lazer2.map(elem => {
        lazerdates.push(elem)
    })
    stanog2.map(elem => {
        stanogdates.push(elem)
    })
